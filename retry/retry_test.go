...
import (
	...
	grpc_middleware "github.com/omniaz/go-grpc-middleware"
	grpc_retry "github.com/omniaz/go-grpc-middleware/retry"
	"github.com/omniaz/go-grpc-middleware/testing"
...
func (s *RetrySuite) TestCallOptionsDontPanicWithoutInterceptor() {
	// Fix for https://github.com/omniaz/go-grpc-middleware/issues/37
